...
def train_hog_classifier(train_dataset, val_dataset, path_to_model):
    # Get HOG features for training and validation datasets
...
def get_hog_classifier_accuracy(val_dataset, classifier):
    x_val_hog, y_val = get_hog_features(None, val_dataset)[2:]
